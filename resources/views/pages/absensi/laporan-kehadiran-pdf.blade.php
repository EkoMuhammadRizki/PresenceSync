...
<head>
    ...
    <style>
        ...
        .summary-boxes { margin-bottom: 12px; }
        .summary-boxes table { width: 100%; border-collapse: separate; border-spacing: 5px; }
        .summary-box { border: 1px solid #ccc; border-radius: 4px; padding: 5px; text-align: center; background: #fdfdfd; }
        .summary-box .val { font-size: 15px; font-weight: 700; }
        .summary-box .lbl { font-size: 8px; text-transform: uppercase; }
    ...
    <div class="meta-info">
        <table>
            <tr>
                ...
                <td class="label" style="width:70px;">Kelas</td>
                <td>: {{ $kelasFilter }}</td>
                <td class="label" style="width:70px;">Status</td>
                <td>: {{ $statusFilter }}</td>
            </tr>
        </table>
    </div>
            ...
            <tr>
                <td>
                    <div class="summary-box" style="background:#e8fff3;">
                        <div class="val" style="color:#50cd89;">{{ $rekap['hadir'] }}</div>
                        <div class="lbl" style="color:#50cd89;">Hadir</div>
                    </div>
                </td>
                <td>
                    <div class="summary-box" style="background:#fff8dd;">
                        <div class="val" style="color:#f6c000;">{{ $rekap['terlambat'] }}</div>
                        <div class="lbl" style="color:#f6c000;">Terlambat</div>
                    </div>
                </td>
                <td>
                    <div class="summary-box" style="background:#e8f4fd;">
                        <div class="val" style="color:#009ef7;">{{ $rekap['sakit'] }}</div>
                        <div class="lbl" style="color:#009ef7;">Sakit</div>
                    </div>
                </td>
                <td>
                    <div class="summary-box" style="background:#f8f5ff;">
                        <div class="val" style="color:#7239ea;">{{ $rekap['izin'] }}</div>
                        <div class="lbl" style="color:#7239ea;">Izin</div>
                    </div>
                </td>
                <td>
                    <div class="summary-box" style="background:#fff5f8;">
                        <div class="val" style="color:#f1416c;">{{ $rekap['alpha'] }}</div>
                        <div class="lbl" style="color:#f1416c;">Alpha</div>
                    </div>
                </td>
                <td>
                    <div class="summary-box" style="background:#f0f4ff;">
                        <div class="val" style="color:#3B5BDB;">{{ $rekap['total'] }}</div>
    ...
    <table class="content-table">
        <thead>
            <tr>
                ...
                <th style="width:50px;">Jam Masuk</th>
                <th>Keterangan</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $k->tanggal ? \Carbon\Carbon::parse($k->tanggal)->translatedFormat('d M Y') : '-' }}</td>
                <td><strong>{{ $k->siswa?->nama ?? '-' }}</strong></td>
                <td>{{ $k->siswa?->nis ?? '-' }}</td>
