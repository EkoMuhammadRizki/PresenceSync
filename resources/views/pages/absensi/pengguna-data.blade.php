        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_pengguna">
            ...
            <tbody class="text-gray-600 fw-bold">
                <tr>
                    ...
                    <td>Admin</td>
                    <td data-order="1"><span class="badge badge-light-primary fw-bolder">Admin</span></td>
                ...
                <tr>
                    ...
                    <td>Siswa</td>
                    <td data-order="5"><span class="badge badge-light-warning fw-bolder">Siswa</span></td>
                ...
                <tr>
                    ...
                    <td>Admin</td>
                    <td data-order="1"><span class="badge badge-light-primary fw-bolder">Staff Admin</span></td>
                ...
                <tr>
                    <td>
                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                            <input class="form-check-input select-item-checkbox" type="checkbox" value="6" />
                        </div>
                    </td>
                    <td>kesiswaan.lia</td>
                    <td>lia@sekolah.sch.id</td>
                    <td>Guru</td>
                    <td data-order="2"><span class="badge badge-light-success fw-bolder">Kesiswaan</span></td>
                    <td>14 Mei 2026, 09:15</td>
                    <td><span class="badge badge-light-success fw-bolder">Aktif</span></td>
                    <td class="text-end">
                        <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                            Aksi {!! theme()->getSvgIcon("icons/duotune/arrows/arr072.svg", "svg-icon-5 m-0") !!}
                ...
                <tr>
                    <td>
                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                            <input class="form-check-input select-item-checkbox" type="checkbox" value="7" />
                        </div>
                    </td>
                    <td>ortu.bambang</td>
                    <td>bambang@gmail.com</td>
                    <td>Orang Tua</td>
                    <td data-order="6"><span class="badge badge-light-dark fw-bolder">Orang Tua</span></td>
                    <td>12 Mei 2026, 18:40</td>
                    <td><span class="badge badge-light-success fw-bolder">Aktif</span></td>
                    <td class="text-end">
                        <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                            Aksi {!! theme()->getSvgIcon("icons/duotune/arrows/arr072.svg", "svg-icon-5 m-0") !!}
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <form id="form_tambah_pengguna" class="form" action="#">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <select class="form-select form-select-solid fw-bolder" data-control="select2" data-dropdown-parent="#modal_tambah_pengguna">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <form id="form_ubah_pengguna" class="form" action="#">
                    ...
                    <div class="fv-row mb-7">
                        <label class="required fw-bold fs-6 mb-2">Status Akun</label>
                        <select class="form-select form-select-solid fw-bolder" data-control="select2" data-dropdown-parent="#modal_ubah_pengguna">
