...
@section('content')
    ...
    @else
        ...
        <div class="d-flex flex-column flex-root">
            ...
            @endif
                ...
                {{ theme()->getView('layout/header/_base') }}
                    ...
                    @if(theme()->getOption('layout', 'footer/display') !== false)
        ...
        <!--begin::Engage-->
        @if(theme()->getOption('layout', 'engage/demos/enabled') || theme()->getOption('layout', 'engage/help/enabled') || theme()->getOption('layout', 'engage/purchase/enabled'))
